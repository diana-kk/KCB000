...
var direction = topArea.text(15, 80, ['2. 음에 알맞은 한자어로 짝지어진 것을', '고르세요.']).attr({
  'font-size': 20
});
...
var circleN = ['①', '②', '③', '④', '⑤'];
var exampleText = ['羽隹 - 耳目', '飛虎 - 木馬', '飛烏 - 隹燕', '飛鳥 - 火牛', '?'];

for (var i = 0; i < circleN.length; i++) {
  var g1 = bottomArea.rect(87, (i * 71) + 230, 200, 55, 10).attr({
    'fill': '#F2F2F2'
  });

  var g2 = bottomArea.text(55, (i * 70) + 265, circleN[i]).attr({
    'font-size': 22,
    'fill': '#777777'
  });

  var fifth = exampleText[i] == '?';
  var g3 = bottomArea.text(185, (i * 71) + 270, exampleText[i]).attr({
    'font-size': (fifth ? 30 : 33),
    'fill': '#282C35',
    'text-anchor': 'middle'
  });

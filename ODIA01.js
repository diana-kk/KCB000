...
topArea.text(15, 80, '1. 그림과 관계 있는 한자를 고르세요.').attr({
  'font-size': 20
});

b01.use().transform('t130, 145').appendTo(topArea);

// 하단
var bottomArea = Paper.g();

var circleN = ['①', '②', '③', '④', '⑤'];
var exampleText = ['魚', '鳥', '犬', '馬', '?'];
...
for (var i = 0; i < circleN.length; i++) {
  ...
  var g2 = bottomArea.text(35 + (i % 2) * 165, 360 + Math.floor(i / 2) * 100, circleN[i]).attr({
    'font-size': 22,
    'fill': '#777777',
    'text-anchor': 'middle'
  });
